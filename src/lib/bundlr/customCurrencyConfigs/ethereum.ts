...
import {CurrencyConfig, Tx} from "@bundlr-network/client/build/common/types";
import BaseWebCurrency from "@bundlr-network/client/build/web/currency";


const ethereumSigner = signers.EthereumSigner; 

export default class CustomEthereumConfig extends BaseWebCurrency {
